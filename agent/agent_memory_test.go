...
func TestTypeMemoryFind(t *testing.T) {
	...
	tc := &TestConcept{}
	agent.newAbstractConcept(tc, &tc.abstractConcept)
...
func TestTypeMemoryAdd(t *testing.T) {
	...
	agent.newAbstractConcept(tc1, &tc1.abstractConcept)
	id1 := tc1.id()
	...
	agent.newAbstractConcept(tc1Copy, &tc1Copy.abstractConcept)
	assert.Equal(t, tm.add(tc1Copy), tc1)
	assert.Len(t, tm.items, 1)

	id2 := -2
	tc2 := &TestConcept{val: 2}
	agent.newAbstractConcept(tc2, &tc2.abstractConcept)
	tc2.cid = id2
	...
	agent.newAbstractConcept(tc3, &tc3.abstractConcept)
	tc3.cid = id3
...
func TestTypeMemoryFreeId(t *testing.T) {
	...
	tc := agent.newTestConcept(1)
	agent.newTestConcept(2)
	agent.newTestConcept(3)
	for i := 0; i < 100; i++ {
...
func TestAgentMemoryTouch(t *testing.T) {
	...
	agent.newAbstractConcept(tc2, &tc2.abstractConcept)
	agent.newAbstractConcept(tc3, &tc3.abstractConcept)
	agent.newAbstractConcept(tc3, &tc4.abstractConcept)
	tc1.cid = 1
	tc2.cid = 2
	tc3.cid = 3
	tc4.cid = 4
