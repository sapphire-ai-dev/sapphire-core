...
func (a *Agent) newAbstractChange(self concept, t actionType, performer object, out **abstractChange) {
	*out = &abstractChange{
		params: map[string]any{},
	}
...
func (a *Agent) newAbstractChangeType(self concept, out **abstractChangeType) {
