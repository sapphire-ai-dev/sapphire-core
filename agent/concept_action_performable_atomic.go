...
func (a *Agent) newAtomicAction(t *atomicActionType, performer object) *atomicAction {
	result := &atomicAction{}
...
func (t *atomicActionType) instantiate(_ ...any) performableAction {
	return t.agent.newAtomicAction(t, t.agent.self)
}
...
func (a *Agent) newAtomicActionType(actionInterface *world.ActionInterface) *atomicActionType {
	result := &atomicActionType{
		actionInterface: actionInterface,
	}
	a.newAbstractPerformableActionType(result, nil, &result.abstractPerformableActionType)
