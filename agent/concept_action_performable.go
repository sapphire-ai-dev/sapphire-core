...
func (a *Agent) newAbstractPerformableAction(self concept,
	t actionType, performer object, out **abstractPerformableAction) {
	*out = &abstractPerformableAction{_state: actionStateIdle}
	a.newAbstractAction(self, t, performer, &(*out).abstractAction)
}
...
func (a *abstractPerformableAction) snapshot(timing int) {
	a._snapshots[timing] = &snapshot{
		mind:      map[int]*memReference{},
		condTruth: map[int]*bool{},
	}

	for _, c := range mindConcepts[concept](a.agent.mind) {
...
func (a *Agent) newAbstractPerformableActionType(self concept,
	receiverType objectType, out **abstractPerformableActionType) {
	*out = &abstractPerformableActionType{
		_conditions:      map[int]*memReference{},
		_causations:      map[int]*memReference{},
		causationRecords: map[int]*causationRecord{},
	}
	a.newAbstractActionType(self, &(*out).abstractActionType)
	if receiverType != nil {
