...
func (a *Agent) newAbstractRelation(self concept, t relationType, lTarget, rTarget concept, out **abstractRelation) {
	*out = &abstractRelation{}
	a.newAbstractConcept(self, &(*out).abstractConcept)
...
func (a *Agent) newAbstractRelationType(self concept, out **abstractRelationType) {
