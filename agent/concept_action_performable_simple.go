...
func (a *Agent) newSimpleAction(t *simpleActionType, performer object, child performableAction) *simpleAction {
	result := &simpleAction{}
...
func (t *simpleActionType) instantiate(args ...any) performableAction {
	return t.agent.newSimpleAction(t, t.agent.self, t.child().instantiate(args))
}
...
func (a *Agent) newSimpleActionType(receiverType objectType, child *atomicActionType) *simpleActionType {
